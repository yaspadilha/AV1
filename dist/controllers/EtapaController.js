...
const EtapaRepository_1 = require("../repositories/EtapaRepository");
...
class EtapaController {
    constructor() {
        this.etapaRepo = new EtapaRepository_1.EtapaRepository();
        this.aeronaveRepo = new AeronaveRepository_1.AeronaveRepository();
        this.funcionarioRepo = new FuncionarioRepository_1.FuncionarioRepository();
    }
    cadastrarEtapaParaAeronave() {
        ...
        const novaEtapa = new Etapa_1.Etapa(id, nome, prazo, "Pendente", []);
