...
exports.AeronaveRepository = void 0;
const Aeronave_1 = require("../models/Aeronave");
const BaseRepository_1 = require("./BaseRepository");
class AeronaveRepository extends BaseRepository_1.BaseRepository {
    constructor() {
        super("aeronaves");
    }
    ...
    registrarAeronave(codigo, modelo, tipoAeronave, capacidade, alcance) {
        const banco = this.lerDados();
        if (banco.some(a => a.codigo === codigo)) {
            console.log("Erro: Já existe uma aeronave com este código.");
            return;
        }
        const novaAeronave = new Aeronave_1.Aeronave(codigo, modelo, tipoAeronave, capacidade, alcance);
...
exports.AeronaveRepository = AeronaveRepository;
